...
formatlog "INFO" "Stopping slothy services"
docker-compose -p slothy-services -f "${BASE_DIR}/docker-compose.yml" stop
docker-compose -p slothy-services -f "${BASE_DIR}/docker-compose.yml" down
