...
def generate_network_manager_request_from_range_config(
    ...
    Purpose:
        ...
        The assumption that if there is no Network Manager request, then the Comms should
...
def generate_s2s_unicast_network_manager_request_from_range_config(
    range_config: Dict[str, Any], channel_properties_list: [Dict]
) -> Dict[str, Any]:
    """
    Purpose:
    ...
    for channel in channel_properties_list:
        channel_list.append(channel.get("channelId"))

    network_manager_request_s2s = {"links": []}
...
def generate_c2s_unicast_network_manager_request_from_range_config(
    ...
    network_manager_request_c2s = {"links": []}
